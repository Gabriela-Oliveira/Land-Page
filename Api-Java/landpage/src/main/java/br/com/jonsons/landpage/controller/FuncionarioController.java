...
public class FuncionarioController {
	...
	@GetMapping("/{codigo}")
	public ResponseEntity<?> getById(@PathVariable Long codigo) throws FuncionarioNotFoundException {
		return ResponseEntity.ok(funcionarioService.getById(codigo));
	}

	// aqui vão ser inseridos novos usuarios e funcioanarios
	@PostMapping
	public ResponseEntity<?> post(@RequestBody Funcionarios funcionario) throws CpfRepetidoException, SalarioInvalidoException {
	...
	public ResponseEntity<?> delete(@PathVariable Long codigo) throws FuncionarioNotFoundException {
